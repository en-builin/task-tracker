...
public class ReportsServiceImpl implements ReportsService {
    ...
    public Map<String, Object> getAllData(LocalDate from, LocalDate to) {
        ...
        result.put("rows", jdbcTemplate.queryForList(SQL_SELECT_ALL_DATA, from, to));
        result.put("total", jdbcTemplate.queryForObject(SQL_SELECT_ALL_TOTAL, BigDecimal.class, from, to));

        return result;
    }

    @Override
    public Map<String, Object> getDataByUser(String userEmail, LocalDate from, LocalDate to) {

        Map<String, Object> result = new HashMap<>();

        result.put("rows", jdbcTemplate.queryForList(SQL_SELECT_DATA_BY_USER, from, to, userEmail));
        result.put("total", jdbcTemplate.queryForObject(SQL_SELECT_TOTAL_BY_USER, BigDecimal.class, from, to, userEmail));
